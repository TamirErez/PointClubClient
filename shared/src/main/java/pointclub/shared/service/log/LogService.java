...
public class LogService {
    ...
    public static void info(LogTag tag, String message, String... params) {
        Log.i(POINTCLUB_TAG + ": " + tag.name().toLowerCase(), String.format(message, (Object[]) params));
    }
    ...
    public static void warn(LogTag tag, String message, String... params) {
        Log.w(POINTCLUB_TAG + ": " + tag.name().toLowerCase(), String.format(message, (Object[]) params));
    }
